...
/***/ function(module, exports, __webpack_require__) {
	...
	var moment = __webpack_require__(17); // 时间格式化库
	// 设置中文格式
	moment.locale('zh-cn');
	...
	module.exports = {
		...
		route: {
			data: function data(transition) {
				var _self = this,
				    tab = transition.to.query.tab || 'all';
		...
		components: {
			'navHead': __webpack_require__(142),
			'slideComp': __webpack_require__(156)
		}
	};
	// </script>
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ajax = __webpack_require__(141);
	module.exports = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		components: {
			'menuComp': __webpack_require__(145),
			'navComp': __webpack_require__(151)
		}
	};
	// </script>
...
/***/ function(module, exports) {
	...
	module.exports = "<aside class=\"side-menu\" :class=\"{'side-menu-transiton': showMenu}\">\r\n\t\t<div class=\"user-info\">\r\n\t\t\t<p class=\"login-no\" v-if=\"!loginName\" @click=\"goEnter\">\r\n\t\t\t\t登录\r\n\t\t\t</p>\r\n\t\t\t<div class=\"login-success\" v-if=\"loginName\">\r\n\t\t\t\t<img class=\"login-user\" :src=\"avatarUrl\" alt=\"头像\">\r\n\t\t\t\t<span class=\"login-name\">{{ loginName }}</span>\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t\t<ul class=\"side-menu-items\">\r\n\t\t\t<li class=\"icon-quanbu iconfont\" v-link=\"{ name: 'yh', query: {tab: 'all'} }\">优惠</li>\r\n\t\t\t<li class=\"icon-hao iconfont\" v-link=\"{ name: 'yh', query: { tab: 'good' } }\">海淘</li>\r\n\t\t\t<li class=\"icon-wenda iconfont\" v-link=\"{ name: 'yh', query: { tab: 'share' } }\">发现</li>\r\n\t\t\t<li class=\"icon-zhaopin iconfont\" v-link=\"{ name: 'yh',query: { tab: 'ask' } }\">原创</li>\r\n\t\t\t<li class=\"icon-hao iconfont\" v-link=\"{ name: 'yh', query: { tab: 'job' }}\">资讯</li>\r\n\t\t\t<li class=\"icon-xiaoxi iconfont br-top\" v-link=\"{ path: '/xiaoxi' }\">消息</li>\r\n\t\t\t<li class=\"icon-about iconfont\" v-link=\"{ path: '/guanyu' }\">关于</li>\r\n\t\t</ul>\r\n\t</aside>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "D:\\WorkingSoftware\\wamp\\www\\webApp\\vuejsPro\\src\\view\\login.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		components: {
			'nvHead': __webpack_require__(142)
		}
...
/***/ function(module, exports) {
	...
	module.exports = "<nv-head app-name=\"登录\" :no-nav=\"true\" :no-plus=\"true\" :no-top-nav=\"true\"></nv-head>\t\r\n\t<section class=\"login\">\r\n\t\t<div class=\"login-input\">\r\n\t\t\t<input type=\"text\" v-model=\"token\" placeholder=\"Access Token\">\r\n\t\t</div>\r\n\t\t<div class=\"login-button\">\r\n\t\t\t<a href=\"\">注册</a><a @click=\"goLogin\">登录</a>\r\n\t\t</div>\r\n\t</section>\r\n\t<div v-if=\"alert.show\" class=\"tishi\">\r\n\t\t<div class=\"tishi-box\">{{ alert.txt }}</div>\r\n\t</div>";
	...
	module.exports = {
		...
		data: function data() {
			return {
				appName: 'VueApp',
				pageType: '海淘',
				navItems: [{ text: '优惠', name: 'yh' }, { text: '海淘', name: 'ht' }, { text: '发现', name: 'fx' }, { text: '原创', name: 'yc' }, { text: '资讯', name: 'zx' }],
				showMenu: false,
				timer: null
			};
		},
...
/***/ function(module, exports) {
	...
	module.exports = "<nav-head :app-name=\"appName\" \r\n\t\t:show-menu.sync=\"showMenu\"\r\n\t\t:page-type=\"pageType\"\r\n\t\t:nav-items=\"navItems\">\r\n\t</nav-head>\r\n\t<div class=\"haitao-lists\">\r\n\t{{ $route.path }}\r\n\t<br>\r\n\t{{ $route.params | json }}\r\n\t<br>\r\n\t<router-view></router-view>\r\n\t\t<a v-for=\"item in haitaoItems\" class=\"list-item\" href=\"javascript:;\">\r\n\t\t\t<div class=\"item-img\">\r\n\t\t\t\t<img :src=\"item.img\" alt=\"图片\">\r\n\t\t\t</div>\r\n\t\t\t<section class=\"item-desc\">\r\n\t\t\t\t<p class=\"item-title\">{{ item.title }}</p>\r\n\t\t\t\t<div class=\"item-detail\">{{ item.detail }}</div>\r\n\t\t\t</section>\r\n\t\t</a>\r\n\t</div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "D:\\WorkingSoftware\\wamp\\www\\webApp\\vuejsPro\\src\\view\\faxian.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
/***/ function(module, exports) {
	...
	module.exports = "<nv-head :app-name=\"appName\"\r\n\t\t:nav-items=\"navItems\"></nv-head>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "D:\\WorkingSoftware\\wamp\\www\\webApp\\vuejsPro\\src\\view\\yuanchuang.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "D:\\WorkingSoftware\\wamp\\www\\webApp\\vuejsPro\\src\\view\\zixun.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "D:\\WorkingSoftware\\wamp\\www\\webApp\\vuejsPro\\src\\view\\detail.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
